...
const createSlot = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield slots_service_1.slotServices.createSlotIntoDB(req === null || req === void 0 ? void 0 : req.body);
...
const getAvailableSlots = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield slots_service_1.slotServices.getAvailableSlots(req === null || req === void 0 ? void 0 : req.query);
    if (result.length === 0) {
        (0, sendResponse_1.default)(res, {
